...
import nurseIcon from '../../style/nurse.png';

export default class NurseSideBar extends React.Component {
    componentDidMount() {
    ...
    render() {
        return (
            <nav className="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar system-sidenav" id="sideMenu">
                <img src={nurseIcon} className="img-responsive img-role" rel="icon" type="image/png" alt="Nurse icon" />
                <div className="account-role">Nurse</div>
                ...
                <ul className="nav nav-pills flex-column system-nav">
                    <li>
                        <Link to={'/nursedashboard'} className="system-nav-link"> <i className="fas fa-home"></i> Dashboard </Link>
                    </li>
